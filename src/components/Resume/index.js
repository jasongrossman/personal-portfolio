...
function Resume() {
    ...
    <section id="Experience">
        ...
        <div class="role">
                <h3 class="company">Suncor Energy Inc.</h3>
                <h4 class="position">Advisor, Card Production – Transaction Management</h4>
                <ul>
                    <li>
        ...
        <div class="role">
                <h3 class="company">Suncor Energy Inc.</h3>
                <h4 class="position">Optimization Analyst – Refining and Logistics</h4>
                <ul>
                    <li>
        ...
        <div class="role">
                <h3 class="company">Suncor Energy Inc.</h3>
                <h4 class="position">Account Manager – Commercial Road Transport</h4>
                <ul>
                    <li>
